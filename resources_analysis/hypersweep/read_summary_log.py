...
num = -1
resources_log = "/afs/crc.nd.edu/group/ccl/work/tphung/alarm-experiments/resources_data/hypersweep/hypersweep.summaries"
...
hypersweep_dir = 'resources_analysis/hypersweep/'
with open(hypersweep_dir+"resources_all.txt", "w") as f:

...
stats = {"num_tasks": 0, 
		 ...
		 "total_mem_t": 0, "avg_total_mem_t": 0,
...
res_file = "resources_data/{}/data/resources_all.txt".format(dataset)

#number of buckets of the cold_bucketing strategy
num_buckets = 2

#output csv file
csv_file = "resources_analysis/{}/results/strategies_evaluation.csv".format(dataset)
